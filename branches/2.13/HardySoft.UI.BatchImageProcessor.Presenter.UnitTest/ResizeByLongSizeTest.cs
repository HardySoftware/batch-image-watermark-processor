...
namespace HardySoft.UI.BatchImageProcessor.Presenter.UnitTest {
	/// <summary>
	///This is a test class for ResizeByLongSizeTest and is intended
	///to contain all ResizeByLongSizeTest Unit Tests
	///</summary>
	[TestClass()]
	public class ResizeByLongSizeTest {
		...
		public void CalculateNewSizeTest1() {
			ResizeByLongSide target = new ResizeByLongSide();
			Size originalSize = new Size(300, 400);
			double newSize = 200;
			Size expected = new Size(150, 200);
